...
class ShardingManager extends EventEmitter {
  ...
  /**
   * Kills all running shards
   * @param {string} [signal='SIGTERM'] The signal to send to all the shards
  ...
  killAll(signal='SIGTERM') {
    ...
    for (const shard of this.shards.values()) {
        promises.push(shard.kill(signal));
    }

    return Promise.all(promises); // Wait for all shards to properly handle their exit
  }
}
