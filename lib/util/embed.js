...
class EmbedUtils {
     ...
     * @param {Discord.Message} msgObj The original message containing the embed
     * @param {Object} editObj The new object data for the embed
     * @param {Boolean} [edit=true] If the embed should be directly updated after modifying it
     * @returns {Discord.MessageEmbed} Returns the modified embed, null if the original message was removed
     */
    ...
    /**
     * @param {Object} oldEmbedObj
     * @returns {Discord.MessageEmbed} returns a new MessageEmbed made from the oldEmbedObj
     */
