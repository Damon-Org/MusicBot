...
module.exports = class Choice {
     ...
     * @param {Boolean} exception If the request should be added next up (true) or handle as a normal song (default=false)
     * @property {Discord.Message} listener
     * @property {Discord.VoiceChannel} voicechannel
     * @property {Discord.GuildMember} requester
     * @property {Song[]} songs
     * @property {Boolean} shouldPlayNext Gets set by our exception param 
     */
